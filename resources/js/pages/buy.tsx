...
export default function Buy({ properties }: BuyProps) {
    const { props } = usePage();
    ...
    const filteredProperties = useMemo(() => {
        return properties.filter((property) => {
            ...
            if (priceRange !== 'All') {
                if (priceRange === 'under-1.5m') matchesPrice = property.price < 1500000;
                else if (priceRange === '1.5m-2.5m') matchesPrice = property.price >= 1500000 && property.price <= 2500000;
                else if (priceRange === 'over-2.5m') matchesPrice = property.price > 2500000;
            }
    ...
    return (
        <PublicLayout>
            <Head title="Buy Premium Properties" />

            {/* Header Banner */}
            <div className="relative overflow-hidden bg-zinc-950 py-24 text-white dark:bg-zinc-950/40">
                {/* Background design elements */}
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-red-900/20 via-zinc-950/10 to-transparent"></div>
                <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-400">
                        Explore our curated selection of luxury estates, modern villas, and premier architectural masterpieces.
                    </p>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <option value="over-2.5m">Over $2.5M</option>
                            </select>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mt-6 flex items-center justify-between border-t border-neutral-100 pt-4 dark:border-zinc-800">
                                        <div className="flex flex-col">
                                            <span className="text-xs text-zinc-400 dark:text-zinc-500">Price</span>
                            ...
                            <div className="flex flex-col p-8">
                                <DialogHeader>
                                    ...
                                    <DialogDescription className="text-zinc-500 dark:text-zinc-400">
                                        Submit an inquiry to receive full details and arrange a viewing.
                                    </DialogDescription>
                                </DialogHeader>
                                ...
                                <div className="mt-4 border-t border-neutral-100 pt-4 dark:border-zinc-900">
                                    <span className="text-xs text-zinc-400">Listed Price</span>
